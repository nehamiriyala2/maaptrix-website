...
export default function FinalCTA() {
  return (
    <section
      id="contact"
      className="relative overflow-hidden bg-white page-container py-9 sm:py-10 lg:py-12"
    >
      <div className="relative overflow-hidden rounded-[28px] border border-slate-800/80 bg-gradient-to-br from-[#061427] via-[#0B1F41] to-[#040D1A] p-7 sm:p-9 lg:p-12 text-white shadow-[0_24px_50px_-12px_rgba(11,31,65,0.35)]">
